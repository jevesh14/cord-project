...
export const Banks = () => {
  ...
  const cityCoords: Record<string, { lat: number; lng: number }> = {
    ...
    'Gurugram': { lat: 28.4595, lng: 77.0266 }, // formerly Gurgaon
    'Gurgaon': { lat: 28.4595, lng: 77.0266 }, // for legacy data
    ...
    'Warangal': { lat: 17.9784, lng: 79.6006 },
